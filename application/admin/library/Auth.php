...
class Auth extends \fast\Auth
{
    ...
    protected function ensureMiniappAgentGroup()
    {
        $allowedRuleNames = [
            ...
            'miniapp/user_setting/del',
            'miniapp/dispatch_mode',
            'miniapp/dispatch_mode/index',
            'miniapp/dispatch_mode/add',
            'miniapp/dispatch_mode/edit',
            'miniapp/dispatch_mode/del',
            'miniapp/dispatch_mode/selectpage',
